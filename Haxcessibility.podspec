#
#  Be sure to run `pod spec lint Haxcessibility.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/martijndeh/Haxcessibility"
  ...
  s.author             = { "martijndeh" => "martijn@ff00ff.nl" }
  # Or just: s.author    = "martijndeh"
  # s.authors            = { "martijndeh" => "martijn@ff00ff.nl" }
  # s.social_media_url   = "http://twitter.com/martijndeh"
  ...
  s.source       = { :git => "https://github.com/martijndeh/Haxcessibility.git", :tag => "1.0.2" }
